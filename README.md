# Some scripts that I use daily when working on drone shows

- A script that scales a mesh so that its closest pair of vertices matches a target distance (ensuring the minimum safe distance between drones).
